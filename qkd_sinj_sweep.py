...
def compute_metrics(phi, pk_S, pk_k, dt, T_rep, laser):
    ...
    return dict(r1=r1, sig_phi=sig_phi, sig_t=sig_t, cv=cv, kl=kl)
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    fig1.savefig('images/qkd_source/sinj_sweep_r1.png', dpi=150)
    print("\n  Saved: images/qkd_source/sinj_sweep_r1.png")
    ...
    plt.tight_layout()
    fig2.savefig('images/qkd_source/sinj_sweep_cost.png', dpi=150)
    print("  Saved: images/qkd_source/sinj_sweep_cost.png")
    ...
    plt.tight_layout()
    fig3.savefig('images/qkd_source/sinj_sweep_tradeoff.png', dpi=150)
    print("  Saved: images/qkd_source/sinj_sweep_tradeoff.png")
