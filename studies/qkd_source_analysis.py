...
from gsdfb.analysis import phase_randomisation_quality
...
if __name__ == '__main__':
    ...
    for f_rep in freqs:
        ...
        for case, s_inj in [('free', 0.0), ('sld', S_INJ)]:
            ...
            # Phase
            pq = phase_randomisation_quality(phi)
            kl, ks, r1, dphi = pq['kl'], pq['ks_stat'], pq['r1'], pq['dphi']
    ...
    plt.tight_layout()
    save_fig(fig1, 'images/qkd_source/phase_randomisation.png', close=False)
    ...
    plt.tight_layout()
    save_fig(fig2, 'images/qkd_source/source_metrics.png', close=False)
    ...
    plt.tight_layout()
    save_fig(fig3, 'images/qkd_source/intensity_correlations.png', close=False)
    ...
    plt.tight_layout()
    save_fig(fig4, 'images/qkd_source/key_rate.png', close=False)
    ...
    plt.tight_layout()
    save_fig(fig5, 'images/qkd_source/photon_number_distribution.png', close=False)
    ...
    save_run(locals(), 'images/qkd_source/qkd_source_data.npz')
