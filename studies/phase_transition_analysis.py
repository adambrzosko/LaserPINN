...
def compute_metrics(phi, pk_S, pk_k, dt, laser):
    """Thin wrapper: adds 'cv' alias for backward compatibility."""
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    save_fig(fig1, 'images/phase_transition/raw_r1_vs_sinj.png', close=False)
    ...
    plt.tight_layout()
    save_fig(fig2, 'images/phase_transition/universal_collapse.png', close=False)
    ...
    plt.tight_layout()
    save_fig(fig3, 'images/phase_transition/Sc_scaling.png', close=False)
    ...
    plt.tight_layout()
    save_fig(fig4, 'images/phase_transition/phase_diagram.png', close=False)
